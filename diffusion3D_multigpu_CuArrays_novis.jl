...
@views function diffusion3D(nt, init_MPI)
    # Physics
    ...
    me, dims   = init_global_grid(nx, ny, nz, init_MPI=init_MPI);              # Initialize the implicit global grid
    select_device()
